...
I will use R and RStudio to create different plots. I will provide all code and output in a separate document before the Lunch & Learn in case you would like to follow along or try the code on your own.
...
There are endless options to customize the appearance of RStudio, including switching to a "dark" mode that saves your eyes during long coding sessions and changing the layout of the panels. You can make adjustments via Tools -\> Global Options.
